...
WEIGHTS = {
    ...
    "boss_kill": 3200, "boss_kill_now": 6000, "hilda": 3000, "dawn_emergency": 16500, "dawn": 3100,
        ...
        if o.type == OptionType.NUMBER:
            ...
            if data.cardType == CardType.POKEMON:
                ...
                if cid == Buddy_Buddy_Poffin:
                    ...
                    elif (target_use_boss and target_can_kill and has_attack_option
                          and active_id == Alakazam and active_has_psychic
                          and target_pokemon is not None
                          and (hand_size - 1) * 20 >= target_pokemon.hp):
                        # H-036: 가스트킬이 이 턴에 확정 성립(어태커 즉시 가동 + 보스 소모 후
                        # 잔여 핸드만으로 킬 데미지)이면 드로 서포터보다 우선한다.
                        score = W["boss_kill_now"]
