...
def heuristic_scores(obs):
    ...
    for o in select.option:
        ...
        if o.type == OptionType.NUMBER:
            ...
            # H-033: 코인 승리 시 선공 선택 (기존 하드코딩 "항상 후공" 반전).
            # 래더 실측: 선공 강제 31경기 67.7% vs 후공 선택 107경기 51.4%.
            score = 8 if context == SelectContext.IS_FIRST else 1
            ...
            if (context == SelectContext.ACTIVATE
                    ...
                    and deck_count - my_prize_count - 1 < 3):
                score = -1
