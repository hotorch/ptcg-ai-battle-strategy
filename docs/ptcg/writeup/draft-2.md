...
Figure citations (2026-09-10): "(Figure B)" §4 build list, "(Figure E, left/right)" §4, "(Figure C)" §5 — Figures B/C/E were previously never named in the body (judge ⑨ note). Body wc -w 1,988 with headings and markers; marker-free submission copy in `writeup/submission-2026-09-11/` (body.md 1,988, gallery captions, deck.csv, README checklist).

Codex fact-check round 2 (2026-09-10 23:50 KST, `review/codex-factcheck-2026-09-10.md`): 95 claims verified incl. all 9/10 numbers; 5 mismatches fixed — §3 "deterministic … no tree search" → fork carries a 2-ply determinized lookahead (fork_policy.py `_search_decide`, USE_SEARCH=True) so reworded; §6 "no hard-coded turn numbers" → fork has turn≤2 setup branches, reworded to "turn-1–2 setup priorities"; §2 Boss "only card" → "only Supporter" (Rare Candy/Poffin outrank draw); §5 "monotone after the first week" → monotone only 8/8–8/15, post-deadline rebounds (8/17 0.226 low, 8/18 0.324), reworded and "new low of 0.254" → "closed at 0.254, below every pre-deadline reading"; §8 "released under MIT" → repo is private, reworded to "MIT-licensed; opens at the hackathon close" and LICENSE added. Trimmed §4 "We held…" and §7 torch clause to stay under budget. Body wc -w 1,993; Kaggle form counter 1,961.
