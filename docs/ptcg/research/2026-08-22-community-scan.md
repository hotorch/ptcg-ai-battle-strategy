...
## 5. 남은 기간 액션 제안 (우선순위순) — 8/22 당일 1·2·3 실행 완료

1. ✅ **그림 C 연장 (8/22 완료)** — 8/16~21 데일리 6개 수급·마이닝, `fig_meta_convergence.png` 15시점으로 재생성. **예측 실현: Dragapult 32.9%, Grimmsnarl 0.7%(균형 도달), TV 0.254 신저점.** 8/17~18 스로틀 아티팩트는 음영·주석 처리.
2. ✅ **rank 추적 (8/22 완료)** — `scripts/watch_rank.py` 신설, `submissions/rank_history.tsv` 기록 시작. 첫 스냅샷: 1395/6809 (8/16 1498/6851 대비 상승 — 퍼지 시작 실증), 브론즈 컷 834.5.
3. ✅ **draft-context 반영 (8/22 완료)** — §4 그림 표·연장 실측 수치, §6 루틴에 watch_rank 편입.
